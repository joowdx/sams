                        ...
                        <div class="p-1 flex-fill" style="overflow: hidden">
                            ...
                            <div id="world-map-markers" style="height: 325px; overflow: hidden" class="mapael">
                                <div class="map">
                                    ...
                                    <div class="zoomButton zoomReset bg-dark" title="Reset zoom">
                                        <i class="fad fa-search"></i>
                                    </div>
                                    <div class="zoomButton zoomIn bg-dark" title="Zoom in">
                                        <i class="fad fa-search-plus"></i>
                                    </div>
                                    <div class="zoomButton zoomOut bg-dark" title="Zoom out">
