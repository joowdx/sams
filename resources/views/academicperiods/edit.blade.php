            ...
            <div class="card-body">
                <form method="post" action="{{ route('academicperiods.update', $period->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="start" type="text" class="form-control @error('start') is-invalid @enderror" name="start" autocomplete="new-start" placeholder="SCHOOL YEAR" value="{{ old('start') ?? $period->start->format('m-d-Y') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="end" type="text" class="form-control @error('end') is-invalid @enderror" name="end" autocomplete="new-end" placeholder="SCHOOL YEAR" value="{{ old('end') ?? $period->end->format('m-d-Y') }}">
